...
import lottie from '../../public/lottie/lottiefiles-logo-animation.json'
import { Player } from '@lottiefiles/react-lottie-player'
import Image from 'next/image'
const Footer = () => {
    return (<>
        <div className="flex items-center justify-center md:justify-end p-4 mt-16 md:mt-0">
            <div className="flex flex-col items-center w-full max-w-xs p-4 bg-white rounded-3xl md:flex-row">
                ...
                <div className="flex flex-col space-y-4">
                    <div className="flex flex-col items-center md:items-start">
                        <h2 className="text-xl font-medium text-orange-500">-Abiola</h2>
                        <p className="text-base font-medium text-gray-400">Full Stack Developer</p>
                        <p className="text-sm font-medium text-slate-400">Thanks for visiting</p>
                    </div>
        ...
        <div className="inline-flex w-full justify-end p-4 ">
            <div className="flex items-center justify-center flex-shrink-0  rounded-xl">
                ...
                <div className="flex flex-row items-center  mt-2  ">
                    ...
                    <div className="inline-flex ml-2 gap-3 p-3 dark:bg-white dark:rounded-full ">
                        <SiNextdotjs fill="#000000" className="w-8 h-8" />
                        <SiTailwindcss fill="#06B6D4" className="w-8 h-8" />
                    </div>
